...
We started where we left off - the CI workflow was timing out trying to SSH to hosts. The problem? The inventory used local IPs like `10.x.x.x` that GitHub Actions runners couldn't reach, even with Tailscale connected.
