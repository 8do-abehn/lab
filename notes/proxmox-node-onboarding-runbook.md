...
# Or check manually
for i in {40..60}; do ping -c 1 -W 1 10.150.10.$i &>/dev/null && echo "10.150.10.$i - UP" || echo "10.150.10.$i - available"; done
```
...
Email: adam.behn@8devops.com (or appropriate)
```
...
IP Address: 10.150.10.XX/24
Gateway: 10.150.10.1
DNS Server: 10.150.10.1 (or appropriate)
```
...
ping pveXXX.taile975f.ts.net

# SSH via Tailscale
ssh root@pveXXX.taile975f.ts.net

# Test web UI
# Open: https://pveXXX.taile975f.ts.net:8006
```
...
ssh root@pve009 "upsc myups@10.150.10.44"

# Verify web UI with Tailscale cert
# Open: https://pve009.taile975f.ts.net:8006
...
ping -c 3 pve001
ping -c 3 10.150.10.44

# From local machine to new node
ping -c 3 10.150.10.XX
ping -c 3 pveXXX.taile975f.ts.net

# Test web UI
curl -k https://10.150.10.XX:8006
curl -k https://pveXXX.taile975f.ts.net:8006
```
...
```bash
# Remove old host key
ssh-keygen -R 10.150.10.XX
ssh-keygen -R pveXXX
ssh-keygen -R pveXXX.taile975f.ts.net
